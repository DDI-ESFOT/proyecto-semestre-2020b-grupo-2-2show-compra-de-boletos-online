...
import "../Styles/comprarEntrada.css";
import { db, auth } from "../firebase";

function ComprarEntrada(props) {
  ...
  const evento = {
    ...
    costoEntrada: 50,
    descripEvento:
      "Este evento digital se transmite desde Ecuador para el mundo, disfruta de un momento placentero y agradable",
    ...
    <div>
      ...
      >
        <div>
          ...
          <Button onClick={generarCompra} loading={loading}>
            Comprar
          </Button>
        </div>
      </Modal>
